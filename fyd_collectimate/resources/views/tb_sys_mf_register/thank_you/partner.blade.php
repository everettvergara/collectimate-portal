            ...
            <div class="row g-2 g-md-3 h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6 mb-3">
                    <div class="text-center mb-3 mb-md-5">
                        ...
                        <h5>We've sent an verification email to:</h5>
                        <a href="mailto:{{ $email ?? '' }}" class="text-black fw-bold mb-3 mb-md-4">{{ $email ?? '' }}</a>
                    </div>
                    <div class="text-center">
                        <p class="mb-3 mb-md-4">Just click on the link in that email to complete your signup. If you don't
                            see
                            it. you may need to <strong>check your spam</strong> folder</p>
                        ...
                        <a href="{{ route('registers.resend-email', ['user' => $user_id]) }}"
                            ...
                            Email</a>
                        <a href="{{ route('home') }}"
                            class="btn btn-outline-primary rounded-0 btn-lg fs-6 px-3 px-md-4 ">Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
