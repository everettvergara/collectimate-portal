                    ...
                    <div class="card text-secondary rounded-4 border-0">
                        <div class="card-body p-4 p-lg-5 my-3 my-lg-5 mx-2">
                            <div
                                ...
                                <h3 class="text-black fw-normal inter">{{ __('Password Updated Successfully') }}</h3>
                                <p class="text-secondary m-0 fw-normal inter text-center">You may now login using your new
                                    credentials.</p>
                            </div>
                            <div class="mt-3">
                                <a href="/login"
                                    class="text-decoration-none btn btn-md btn-danger w-100 rounded-5 text-white">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
