...
use App\Http\Requests\tb_sys_mf_mod_access_type_request;
use App\Models\tb_sys_mf_access_type;
use App\Models\tb_sys_mf_mod_access_type;
use Illuminate\Http\Request;

class tb_sys_mf_mod_access_type_controller extends Controller
{
    protected $route;
    protected $route_var;
    ...
    {
        $this->route = 'mod-access-types';
        $this->route_var = 'mod_access_type';
        $this->header_route = 'mods';
        $this->header_route_var = 'mod';
        $this->title = 'MOD Access Types';
        $this->view_path = 'tb_sys_mf_mod_access_type';
        $this->pk_var = 'mod_id';
        $this->pk_val = 'mod';
    }
    ...
    public function store(tb_sys_mf_mod_access_type_request $r){
        $validatedData = $r->validated();
        $datum = new tb_sys_mf_mod_access_type();
    ...
    public function show($id){
        $datum = tb_sys_mf_mod_access_type::findOrFail($id);
    ...
    public function update(tb_sys_mf_mod_access_type_request $r, $id){
        $datum = tb_sys_mf_mod_access_type::findOrFail($id);
        $validatedData = $r->validated();
        $datum->fill($validatedData);
        $datum->update();
